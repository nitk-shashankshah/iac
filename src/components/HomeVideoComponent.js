...
import grazingVideo from '../assets/images/grazingCropped.mp4';
import cowVideo from '../assets/images/cowCropped.mp4';
    ...
    <div className="darkBg">
      ...
      <main>          
        <video autoplay muted loop id="myVideo">
          <source src={this.state.urlVideo} type="video/mp4" />
